"""Task 4 experiment B — same prompt as baseline, MAX_NEW_TOKENS reduced to 60."""
...
OUTPUT_PATH = "assignment_04b.xlsx"
MAX_NEW_TOKENS = 60  # forces brevity; fewer tokens = less room to hallucinate
